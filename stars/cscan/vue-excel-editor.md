...
Disable the vertical scrolling by mouse
...
Column visibility, default is false
...
Get an array of the selected row hash
...
The buffer of undo, it will be removed after undo or table changed
