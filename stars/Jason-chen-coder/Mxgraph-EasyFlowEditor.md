...
stars: 207
description: 基于mxGraph和Vue2.0 设计的流程图编辑器（A flowchart editor designed with mxGraph and Vue 2.0）
...
4.绘制具备树形结构的拓扑图 对于自动布局，我们可以根据官网提供的 mxHierarchicalLayout 模块,它提供了 getLayout 钩子。可以重写它以返回给定 cell 的子节点的布局算法。
