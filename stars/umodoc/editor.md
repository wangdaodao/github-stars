...
此外，Umo Editor 还支持自定义扩展、多语言设置和暗色主题。同时我们提供了单独的文本预览组件 Umo Viewer，用户可以在项目中使用该组件来预览文档。
...
-   Standalone document preview component Umo Viewer
...
-   SevenDreamYang：🛠️ Enhanced TypeScript support
...
-   vace：🛠️ Contributed code
-   Mikasa33：🛠️ Contributed code
